...
fetch_repo() {
  ...
  git "${GIT_ARGS[@]}" -C "${dir}" fetch --depth=1 --recurse-submodules=no origin "${ref}"
...
fetch_repo proton https://github.com/ValveSoftware/Proton.git bleeding-edge
fetch_repo box64 https://github.com/ptitSeb/box64.git main
fetch_repo wine https://github.com/wine-mirror/wine.git master
fetch_repo dxvk https://github.com/doitsujin/dxvk.git master
fetch_repo vkd3d-proton https://github.com/HansKristian-Work/vkd3d-proton.git master
